...
class ModelZambezi:
    ...
    def evaluate(self, var):
        ...
        ### Second difference
        objectives = open("../objs/full/" + self.PolicySim + "_simulated.objs",
    ...
    def simulate(self):
        ...
        folder_path = "../storage_release/full_policy_simulation/"
        ...
        for reservoir in ['cb', 'itt', 'ka', 'kgu', 'kgl']:
            ...
            mass_balance_ReservoirSim[reservoir] = open(
                os.path.join(folder_path + reservoir + "_" + self.PolicySim + ".txt"), 'w+')
        ### End diff
        ...
        gg_hydKGU, gg_hydITT, gg_hydKA, gg_hydCB, gg_hydKGL, gg_hydVF, \
            ...
            deficitHYD_ka, deficitHYD_cb, deficitHYD_kgl = tuple(39 * [np.empty(0)])
